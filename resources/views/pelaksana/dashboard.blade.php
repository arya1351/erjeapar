...
@section('content')
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-4 mb-3">
                <div class="card">
                    <div class="card-body text-center">
                        <h1 class="m-2">{{ $laporans }}</h1>
                        <h3 class="m-2">Pengajuan Laporan</h3>
                    </div>
                </div>
            </div>
        </div>
        @if (!empty($gambargedungs))
    ...
    function drawCanvas(gambargedungId) {
        ...
        image.onload = function() {
            ...
            fetch(`/dashboard/${gambargedungId}/mapping`)
                ...
                .catch(error => console.error("Data tidak ditemukan!"));
        };
    }
