                            ...
                            <tbody>
                                @forelse ($laporans as $laporan)
                                    <tr>
                                        ...
                                        <td class="border-bottom-0">
                                            <p class="fw-normal mb-0">{{ $laporan->kepalabagian }}</p>
                                        </td>
                                        <td class="border-bottom-0">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p><strong>Pembuat :</strong>
                                                        {{ $laporan->pembuat }}</p>
                                                    <p><strong>Kepala Bagian :</strong>
                                                        {{ $laporan->kepalabagian }}</p>
                                                    <p><strong>HRD :</strong>
                                                        {{ $laporan->hrd }}</p>
                                                ...
                                                <div class="modal-footer">
                                                    @if ($laporan->komponens->isNotEmpty())
                                                        <button type="button" class="btn btn-success"
                                                            onclick="window.location.href='{{ route('kepalabagian.cetaklaporan', $laporan->id) }}'">Print</button>
                                                    @else
