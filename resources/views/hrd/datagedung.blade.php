...
@section('sidebar')
    <aside class="left-sidebar">
        <!-- Sidebar scroll-->
        <div>
            <div class="brand-logo d-flex align-items-center justify-content-between row mx-auto">
                ...
                <a href="{{ route('hrd.dashboard') }}" class="fs-6 fw-bolder text-center text-black">
                    Monitoring Apar
                </a>
                                    ...
                                    <tr class="border-bottom">
                                        ...
                                        <td class="border-bottom-0">
                                            <h6 class="fw-semibold mb-1"><img
                                                    ...
                                                    width="500" class="border-3 border border-black"></h6>
                                        </td>
                                                ...
                                                <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <ul>
                                                                    <li
                                                                        ...
                                                                        <a href=""
                                                                            class="justify-content-center align-items-center text-center text-white">{{ $gambargedung->id }}</a>
                                                                        <button type="button"
                                                                    ...
                                                                    <li class="alert mx-4 border bg-white text-white">
                                                                        <a href=""
                                                    ...
                                                    <div class="col justify-content-center">
                                                        <img id="preview"
                                                            ...
                                                            class="img-fluid border-3 justify-content-center mx-auto mt-3 border border-black">
                                                    </div>
                                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <img id="preimage" src="#" alt="Image Preview"
                                class="img-fluid justify-content-center mx-auto mt-3">
                            <div class="modal-footer">
